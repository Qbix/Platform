...
function HTMLeditor(el,options) {
    ...
    let keyboardTracker = (function () {
        ...
        function isIOSKeyboardActive() {
            if(visualViewport.height < window.innerHeight && Math.abs(document.documentElement.clientHeight - visualViewport.height) > 10 ) {
                _keyboardVisible = true;
            } else {
                _keyboardVisible = false;
            }
...
/* 
    ...
    window.visualViewport.addEventListener("resize", self.handlerOnScroll);
    window.visualViewport.addEventListener("scroll", self.handlerOnScroll);
