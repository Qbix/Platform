        ...
        if(!_isiOS) {
            ...
            if(_elBarIsStickyTo) {
                ...
                if(Math.round(shouldHaveTopPos) == Math.round(visualViewport.offsetTop)) {
                    ...
                    updatedTopPos = visualViewport.offsetTop - (visualViewport.offsetTop * rect.top * visualViewport.height) + shouldHaveTopPos - stickyRect.height;//129−129×149×359.65+208−70=138
                }
                ...
                //updatedTopPos = visualViewport.offsetTop - (visualViewport.offsetTop * rect.top * visualViewport.height) + shouldHaveTopPos - Math.abs(rect.top - shouldHaveTopPos);//129−129×149×359.65+208−70=138
                //updatedTopPos = (shouldHaveTopPos - rect.top);//386−36+403−420
                if((shouldHaveTopPos == visualViewport.offsetTop && visualViewport.offsetTop == visualViewport.pageTop) || Math.sign(rect.top) === -1) {
                    updatedTopPos = (shouldHaveTopPos - rect.top + visualViewport.offsetTop - visualViewport.pageTop);//386−36+403−420

                } else if((shouldHaveTopPos > visualViewport.offsetTop && visualViewport.offsetTop == visualViewport.pageTop) || Math.sign(rect.top) === -1) {
                    updatedTopPos = shouldHaveTopPos - rect.top - visualViewport.offsetTop - visualViewport.pageTop + visualViewport.height;//208−126−152.328125−152.328125+359.65625
